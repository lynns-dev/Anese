...
const BANNER_MESSAGES = ['Free shipping $50+', '15% off with code ANESE15'];
        ...
        <div style={{ ...S.wrap, textAlign: 'center' }}>
          ...
          <div className="hm-grid" style={{ display: 'grid', marginTop: 46, border: `1px solid ${T.line}`, textAlign: 'left' }}>
            ...
            <div className="hm-cell" style={{ ...vcell, background: T.ink, color: T.white }}>
              <div style={{ ...vtag, color: 'rgba(252,251,247,0.6)' }}>One jar of ANESE</div>
        ...
        <div style={{ ...S.wrap, textAlign: 'center' }}>
          ...
          <div className="rit-grid" style={ritGrid}>
            {[['i', 'After the bath', 'Press the puff into the powder. Scent lives best on warm, clean skin.'],
              ['ii', 'Sweep where you’re noticed', 'Collarbones, shoulders, the backs of the knees. A anese, not a coat.'],
...
const heroBg = {
  ...
  backgroundImage: 'url(/images/anese-model-7.9.png)', backgroundSize: 'cover', backgroundPosition: 'center 25%',

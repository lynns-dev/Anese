export const PRODUCTS = [
  {
    ...
    price: 32,
    size: '4 oz · 125ml',
    // Order: jar, [lifestyle hero — the hover-reveal image on collection
    // cards, see ProductVisual's images[1] swap], then model/texture/
    // remaining lifestyle shots.
    images: [
      '/images/anese-product-4oz-poppy6-v2.png',
      '/images/anese-lifestyle-hero.png',
      '/images/anese-benefits-icons.png',
    ...
    category: 'scrub',
    badge: 'Bestseller',
    tagline: 'Smoother skin, no rough patches',
  ...
  },
  {
    ...
    category: 'bundle',
    tagline: 'Smooth, glowing skin — full routine',
  ...
  },
  {
    ...
    category: 'body-rub',
    tagline: 'Soft skin, coconut glow',
  ...
  },
  {
    ...
    category: 'body-cream',
    tagline: 'Deep moisture, no greasy feel',
  ...
  },
  {
    ...
    category: 'accessory',
    tagline: 'Soft, reusable, travel-ready',

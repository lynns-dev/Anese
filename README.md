# ANESE — E-commerce (Next.js + Square)

Minimal black-and-white storefront for ANESE scented body powder. Next.js 14
...
3. Add these Environment Variables in Vercel (Project → Settings → Environment
   ...
   | `NEXT_PUBLIC_BASE_URL` | your deployed URL, e.g. `https://anese.vercel.app` |

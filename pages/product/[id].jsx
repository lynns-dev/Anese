...
const HOW_TO_USE = [
  ...
  ['Sweep where you’re noticed', 'Collarbones, shoulders, the backs of the knees. A anese, not a coat.'],
...
const REEL_VIDEOS = [
  ...
  { src: '/videos/ANESE_ADS_In_a_direct-to-consumer_style_a_woman_with_dark_b2adepH-.mp4' },
];
...
const FAQS = [
  ...
  ['Is it vegan and cruelty-free?', 'Yes — every ANESE formula is vegan-friendly and never tested on animals.'],
        ...
        <div className="pdp-grid" style={grid}>
          ...
          <div style={infoCol}>
            ...
            {product.category === 'fragrance' && (
              <p style={puffIncludedNote}>Comes with the Anese Luxury Puff for effortless, everyday application.</p>
            )}

# ANESE Full E-Commerce Site — Deployment Guide

This is a Next.js e-commerce site with a full product catalog, detailed product pages, shopping cart, and a custom checkout page that charges cards via Square (no Shopify, no hosted redirect). Built entirely in ANESE's quiet-luxury aesthetic.

## What You Get

- **Homepage** with hero, featured products, brand story, and value proposition
- **Product catalog page** with all ANESE offerings
...
2. Click "Add Domain"
3. Enter the domain you want (e.g., `checkout.anesepuff.com`)

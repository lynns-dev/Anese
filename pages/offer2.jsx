...
// is something ANESE actually backs up elsewhere on the site (lib/products.js,
...
// actually has, no guarantee terms ANESE doesn't really offer.
...
export default function Offer2Page() {
  ...
  return (
    <div style={{ background: T.white }}>
      <Head>
        <title>ANESE — Find Your Scent</title>
      </Head>
        ...
        <section className="o2-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'center', padding: '48px 0 20px' }}>
          <div>
            ...
            <button className="cta-3d" onClick={handleClaim} disabled={claiming} style={{ ...ctaBtn, marginTop: 28, height: 52, opacity: claiming ? 0.6 : 1 }}>
              {claiming ? 'Loading…' : 'Shop ANESE — 15% Off →'}
            </button>
          </div>
